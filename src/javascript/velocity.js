var func_1488536948783 = (function () { /*
...
(function(root) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c190 = "\r",
        peg$c191 = peg$literalExpectation("\r", false),
        ...
        '10': function () { // ObjLiteral
            ...
            if (this.tail) {
                ...
                for (var i = 0, len = this.tail.length; i < len; i++) {
                    k = executor.run(this.tail[i].key);
                    v = executor.run(this.tail[i].val);
                    re[k] = v;
                }
            }
            return re;
...
if (typeof exports !== 'undefined') {
    if (typeof module !== 'undefined' && module.exports) {
        exports = module.exports = func_1488536948783;
    }
} else {
    window.velocity = func_1488536948783;
}
