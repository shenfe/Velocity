...
namespace common\widgets\phpVelocity;
...
class Parser{
    ...
    private function peg_parseStringLiteral() {
      ...
      if ($s1 !== $this->peg_FAILED) {
        ...
        if ($s3 === $this->peg_FAILED) {
          $s3 = $this->peg_parseUnescapedChar();
          if ($s3 === $this->peg_FAILED) {
      ...
      if ($s0 === $this->peg_FAILED) {
        ...
        if ($s1 !== $this->peg_FAILED) {
          $s2 = $this->peg_c2;
          $s3 = $this->peg_parseUnescapedChar_raw();
          if ($s3 === $this->peg_FAILED) {
            $s3 = $this->peg_parseChar();
            if ($s3 === $this->peg_FAILED) {
    ...
    private function peg_parseUnescapedChar() {

      $s0 = $this->peg_currPos;
      $s1 = $this->peg_currPos;
      $this->peg_silentFails++;
      $s2 = $this->peg_parseQuotation_mark();
      if ($s2 === $this->peg_FAILED) {
        $s2 = $this->peg_parseEscape();
        if ($s2 === $this->peg_FAILED) {
          $s2 = $this->peg_parseEOL();
        }
      }
      $this->peg_silentFails--;
      if ($s2 === $this->peg_FAILED) {
    ...
    private function peg_parseUnescapedChar_raw() {

      $s0 = $this->peg_currPos;
      $s1 = $this->peg_currPos;
      $this->peg_silentFails++;
      $s2 = $this->peg_parseQuotation_mark_raw();
      if ($s2 === $this->peg_FAILED) {
        $s2 = $this->peg_parseEscape();
        if ($s2 === $this->peg_FAILED) {
          $s2 = $this->peg_parseEOL();
    ...
    private function peg_parsePositiveFloatLiteral() {
      ...
      $s0 = $this->peg_currPos;
      if (mb_substr($this->input, $this->peg_currPos, 1, "UTF-8") === $this->peg_c170) {
        $s1 = $this->peg_c170;
        $this->peg_currPos++;
      } else {
        $s1 = $this->peg_FAILED;
    ...
    private function peg_parseBoolLiteral() {
      ...
      $s0 = $this->peg_currPos;
      if (mb_substr($this->input, $this->peg_currPos, 4, "UTF-8") === $this->peg_c172) {
        $s1 = $this->peg_c172;
        $this->peg_currPos += 4;
      } else {
        $s1 = $this->peg_FAILED;
      ...
      if ($s0 === $this->peg_FAILED) {
        ...
        if ($s1 !== $this->peg_FAILED) {
          $this->peg_reportedPos = $s0;
          $s1 = call_user_func($this->peg_c177);
        }
        $s0 = $s1;
      }
    ...
    private function peg_parseHEXDIG() {
      ...
      if (peg_regex_test($this->peg_c180, mb_substr($this->input, $this->peg_currPos, 1, "UTF-8"))) {
        $s0 = mb_substr($this->input, $this->peg_currPos, 1, "UTF-8");
        $this->peg_currPos++;
      } else {
        $s0 = $this->peg_FAILED;
    ...
    private function peg_parseR_R_BRAC() {
      ...
      $s1 = $this->peg_parse_();
      if ($s1 !== $this->peg_FAILED) {
        if (mb_substr($this->input, $this->peg_currPos, 1, "UTF-8") === $this->peg_c186) {
          $s2 = $this->peg_c186;
          $this->peg_currPos++;
        } else {
          $s2 = $this->peg_FAILED;
    ...
    private function peg_parseEOL() {
      ...
      if ($s0 === $this->peg_FAILED) {
        if (mb_substr($this->input, $this->peg_currPos, 2, "UTF-8") === $this->peg_c194) {
          $s0 = $this->peg_c194;
          $this->peg_currPos += 2;
        } else {
          $s0 = $this->peg_FAILED;
  ...
  public function parse($input) {
    ...
    $this->peg_c166 = "/^[1-9]/";
    $this->peg_c167 = array( "type" => "class", "value" => "[1-9]", "description" => "[1-9]" );
    $this->peg_c168 = "/^[0-9]/";
    $this->peg_c169 = array( "type" => "class", "value" => "[0-9]", "description" => "[0-9]" );
    $this->peg_c170 = "0";
    $this->peg_c171 = array( "type" => "literal", "value" => "0", "description" => "\"0\"" );
    $this->peg_c172 = "true";
    $this->peg_c173 = array( "type" => "literal", "value" => "true", "description" => "\"true\"" );
    $this->peg_c174 = function() { return true; };
    $this->peg_c175 = "false";
    $this->peg_c176 = array( "type" => "literal", "value" => "false", "description" => "\"false\"" );
    $this->peg_c177 = function() { return false; };
    $this->peg_c178 = function() { return floatval($this->text()); };
    $this->peg_c179 = function() { return 0; };
    $this->peg_c180 = "/^[0-9a-f]/i";
    $this->peg_c181 = array( "type" => "class", "value" => "[0-9a-f]i", "description" => "[0-9a-f]i" );
    $this->peg_c182 = "/^[ \\t\\n\\r\\x0B\\f]/";
    $this->peg_c183 = array( "type" => "class", "value" => "[ \\t\\n\\r\\x0B\\f]", "description" => "[ \\t\\n\\r\\x0B\\f]" );
    $this->peg_c184 = array("type" => "other", "description" => "whitespaces" );
    $this->peg_c185 = array("type" => "other", "description" => "whitespace" );
    $this->peg_c186 = ")";
    $this->peg_c187 = array( "type" => "literal", "value" => ")", "description" => "\")\"" );
    $this->peg_c188 = "]";
    $this->peg_c189 = array( "type" => "literal", "value" => "]", "description" => "\"]\"" );
    $this->peg_c190 = "}";
    $this->peg_c191 = array( "type" => "literal", "value" => "}", "description" => "\"}\"" );
    $this->peg_c192 = "\n";
    $this->peg_c193 = array( "type" => "literal", "value" => "\n", "description" => "\"\\n\"" );
    $this->peg_c194 = "\r\n";
    $this->peg_c195 = array( "type" => "literal", "value" => "\r\n", "description" => "\"\\r\\n\"" );
    $this->peg_c196 = "\r";
    $this->peg_c197 = array( "type" => "literal", "value" => "\r", "description" => "\"\\r\"" );
...
class Main extends Component {
    ...
    function init () {
        ...
        $this->cache = array();
        $this->compile_dir = \Yii::getAlias($this->compile_dir);
    }
    ...
    public function render ($tmplpath, $data = null, $clear = false) {
        ...
        \yii\helpers\FileHelper::createDirectory(dirname($compilepath));
